...
DEV_DATA_LOCAL_DB="$(pwd)/velix-dev-data/local.db"
SATYA_TEST_HOST_DB="$(pwd)/velix-dev-data/host/$SATYA_TEST_ORG/host.db"
VELIX_HOST_DB="$(pwd)/velix-dev-data/host/$VELIX_ORG/host.db"
