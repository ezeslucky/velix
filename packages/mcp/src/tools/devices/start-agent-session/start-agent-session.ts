...
export function registerTaskLaunchTool(server: McpServer) {
	server.registerTool(
		...
		{
			description:
				"Start an autonomous AI session for a task in an existing workspace. Supports terminal agents and Velix. When paneId is provided, launch behavior is scoped to the tab containing that pane.",
