...
describe("getTrustedVercelPreviewOrigins", () => {
	it("returns sibling preview origins for API preview deployments", () => {
		expect(
			getTrustedVercelPreviewOrigins("https://api-pr-2837-velix.vercel.app"),
		).toEqual([
			"https://web-pr-2837-velix.vercel.app",
			"https://admin-pr-2837-velix.vercel.app",
			"https://marketing-pr-2837-velix.vercel.app",
		]);
	});
	...
	it("returns sibling preview origins for branch preview deployments", () => {
		expect(
			getTrustedVercelPreviewOrigins(
				"https://api-git-add-security-headers-velix.vercel.app",
			),
		).toEqual([
			"https://web-git-add-security-headers-velix.vercel.app",
			"https://admin-git-add-security-headers-velix.vercel.app",
			"https://marketing-git-add-security-headers-velix.vercel.app",
		]);
	});
