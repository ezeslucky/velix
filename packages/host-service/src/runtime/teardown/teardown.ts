...
import { TEARDOWN_TIMEOUT_MS } from "@velix/shared/constants";
...
export const TEARDOWN_SCRIPT_REL_PATH = ".velix/teardown.sh";
...
/**
 * Runs `.velix/teardown.sh` inside the workspace, reusing the same
