...
## Major Feature Name <PRBadge url="https://github.com/ezeslucky/velix/pull/NUMBER" />
...
## Another Major Feature <PRBadge url="https://github.com/ezeslucky/velix/pull/NUMBER" />

Brief description of the feature and its benefit to users.

## Improvements

- **Improvement name** - Brief description <PRBadge url="https://github.com/ezeslucky/velix/pull/NUMBER" />
- **Another improvement** - Brief description <PRBadge url="https://github.com/ezeslucky/velix/pull/NUMBER" />

---

**Bug fixes**

- Fixed issue with X <PRBadge url="https://github.com/ezeslucky/velix/pull/NUMBER" />
- Resolved Y problem <PRBadge url="https://github.com/ezeslucky/velix/pull/NUMBER" />
```
