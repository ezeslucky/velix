...
1. `react-mosaic`
2. `FlexLayout`
3. Our proposed Velix pane-layout implementation
...
That is the model I would treat as “correct” for Velix, even where it diverges from both reference libraries.
