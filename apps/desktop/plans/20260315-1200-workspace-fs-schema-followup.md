...
```bash
rg -n "@velix/workspace-fs/host" apps/desktop/src
...
- no desktop router outside the filesystem adapter imports `@velix/workspace-fs/host` for workspace file ops
