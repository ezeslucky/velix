...
- basic find support
- theme application using existing Velix theme tokens
...
- map Velix theme tokens to a shared editor theme contract
...
2. Should find be implemented with native CodeMirror search UI, or should it continue to route through Velix-owned UI controls?
