...
- **Physical Copy:** `/tmp/velix-desktop-pre-refactor` (cloned at pre-refactor state for easy cross-reference)
- **Original Structure:** `/tmp/velix-desktop-pre-refactor/apps/desktop/src/renderer/screens/main/`
- **Compare Command:** `git diff pre-router-refactor-20260112 HEAD`
- **Checkout Original:** `git checkout pre-router-refactor-20260112` (or reference `/tmp/velix-desktop-pre-refactor`)
