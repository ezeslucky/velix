...
describe("resolveFileIconAssetUrl", () => {
	...
	it("resolves against the packaged renderer index file", () => {
		expect(
			resolveFileIconAssetUrl(
				"typescript",
				"file:///Applications/Velix.app/Contents/Resources/app.asar/dist/renderer/index.html#/workspace/123",
			),
		).toBe(
			"file:///Applications/Velix.app/Contents/Resources/app.asar/dist/renderer/file-icons/typescript.svg",
		);
	});
});
