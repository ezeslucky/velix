...
describe("getBaseName", () => {
	describe("posix paths", () => {
		it("returns the final segment of a standard absolute path", () => {
			expect(getBaseName("/Users/alice/projects/velix")).toBe("velix");
		});
		...
		it("returns the single segment when path has no separators", () => {
			expect(getBaseName("velix")).toBe("velix");
		});
	...
	describe("windows paths", () => {
		...
		it("handles consecutive trailing backslashes", () => {
			expect(getBaseName("C:\\Users\\alice\\velix\\\\\\")).toBe("velix");
		});
	});
	...
	describe("edge cases", () => {
		...
		it("preserves a relative path final segment", () => {
			expect(getBaseName("projects/velix")).toBe("velix");
		});
