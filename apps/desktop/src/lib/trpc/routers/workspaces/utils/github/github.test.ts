						...
						nodes: [
							{
								...
								url: "https://github.com/ezeslucky/velix/pull/2681#discussion_r42",
			...
			parseConversationCommentsResponse([
				{
					...
					html_url:
						"https://github.com/ezeslucky/velix/pull/2681#issuecomment-7",
				},
			]),
		).toEqual([
			{
				...
				url: "https://github.com/ezeslucky/velix/pull/2681#issuecomment-7",
				kind: "conversation",
				isResolved: false,
			},
		]);
