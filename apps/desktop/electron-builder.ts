...
nodeGypRebuild: false,
	...
	mac: {
		...
		extendInfo: {
			...
			NSMicrophoneUsageDescription:
				"Velix needs microphone access so voice-enabled tools like Codex transcription can capture audio input.",
			// Required for macOS local network permission prompt
			NSLocalNetworkUsageDescription:
				"Velix needs access to your local network to discover and connect to development servers running on your network.",
			...
			NSAppleEventsUsageDescription:
				"Velix needs to interact with other applications to run terminal commands and development tools.",
		},
	},
	...
	linux: {
		...
		target: ["AppImage"],
		artifactName: `velix-\${version}-\${arch}.\${ext}`,
	},
