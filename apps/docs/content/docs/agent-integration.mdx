...
Velix includes a built-in chat panel for AI interactions without leaving the app.
...
- **Model Override** - Optional model override for Velix Chat
...
- **On** - Terminal agents run their command right away, and Velix Chat sends the task prompt immediately
- **Off** - Terminal agents stage the command without pressing Enter, and Velix Chat opens as a draft instead
