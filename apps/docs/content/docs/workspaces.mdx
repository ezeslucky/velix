...
<YouTubeVideo id="8PuptrsyNvM" title="Velix Workspaces" thumbnail="/images/branches.png" />
...
If you have existing git worktrees on disk, use the **Import** tab in the New Workspace modal to bring them into Velix. Click **Import all** to bulk-import all discovered worktrees at once.
