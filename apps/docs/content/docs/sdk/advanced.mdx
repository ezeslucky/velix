...
const TARGET_HOST_ID = process.env.VELIX_TARGET_HOST_ID!;  // see hosts.list()
const PROJECT_ID = process.env.VELIX_PROJECT_ID!;          // see projects.list()
...
const client = new Velix();
const HOST_ID = process.env.VELIX_TARGET_HOST_ID!;
const PROJECT_ID = process.env.VELIX_PROJECT_ID!; // see projects.list()
