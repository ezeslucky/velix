---
title: Custom Themes
description: Build, edit, and import your own Velix theme files
---
...
```text
Customize this Velix theme JSON to feel like a neon cyberpunk arcade.
Keep the schema valid. Preserve all required ui and terminal keys.
Return the full JSON file contents only.
```

Then save the returned JSON and import it in Velix.
...
Missing values fall back to Velix defaults for the selected theme type.
