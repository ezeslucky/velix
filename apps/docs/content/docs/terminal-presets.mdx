...
<YouTubeVideo id="jT8AoqYTwRU" title="Velix Presets" thumbnail="/images/preset.png" />
...
Pre-configured presets for popular AI agents. Defaults mirror the bundled Velix launch settings for each agent. Claude and Codex use their most permissive bypass flags; edit any preset to change its permission mode.
