...
description: Connect Velix to Vercel AI Gateway, OpenRouter, AWS Bedrock, Google Vertex, and other providers
---

If you're using Velix in the terminal - any CLI agent (Claude Code, Codex, Curser Agents, etc.)
