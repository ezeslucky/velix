...
export const mockRepos: MockRepo[] = [
	{ id: "1", name: "velix", fullName: "velixai/velix" },
	{ id: "2", name: "docs", fullName: "velixai/docs" },
	{ id: "3", name: "marketing", fullName: "velixai/marketing" },
	{ id: "4", name: "api-server", fullName: "velixai/api-server" },
	{ id: "5", name: "mobile-app", fullName: "velixai/mobile-app" },
];
...
export const mockWorkspaces: MockWorkspace[] = [
	...
	},
	{
		...
		repoId: "3",
		repoFullName: "velixai/marketing",
		branch: "feature/auth",
	},
	{
		id: "workspace-3",
		name: "API Stripe",
		repoId: "4",
		repoFullName: "velixai/api-server",
		branch: "dev",
	},
	{
		id: "workspace-4",
	...
	},
	{
		...
		name: "Mobile CI",
		repoId: "5",
		repoFullName: "velixai/mobile-app",
		branch: "main",
	},
];
