...
## SQLite Local Database <PRBadge url="https://github.com/ezeslucky/velix/pull/477" />

- Desktop app now uses a local SQLite-backed database with automatic migration from the legacy JSON store
- Adds `@velix/local-db` package with Drizzle ORM schema for SQLite
...
## Sentry Error Tracking <PRBadge url="https://github.com/ezeslucky/velix/pull/484" />
...
## Features and FAQ Sections <PRBadge url="https://github.com/ezeslucky/velix/pull/472" />
