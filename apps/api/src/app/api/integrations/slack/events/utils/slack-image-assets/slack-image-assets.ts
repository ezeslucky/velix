...
export function formatSlackImageAssetError(error: unknown): string {
	...
	if (error.code === "reauth_required") {
		return "I couldn't access one or more Slack images because this workspace needs updated Slack permissions (`files:read`). Please reconnect the Velix Slack integration and try again.";
	}
