...
export function buildHomeView({
	...
	const blocks: KnownBlock[] = [
		...
		},
		{
			...
			text: {
				type: "mrkdwn",
				text: "Velix is your AI coding assistant - spin up cloud agents, plan tasks, do code reviews, and more, all without leaving Slack.",
			},
		},
		{ type: "divider" },
				...
				elements: [
					{
						...
						confirm: {
							...
							text: {
								type: "mrkdwn",
								text: "Are you sure you want to disconnect your Velix account?",
							},
		...
		blocks.push(
			{
				...
				text: {
					type: "mrkdwn",
					text: "Link your Slack account to your Velix account to personalize your experience.",
				},
			},
			{
				type: "actions",
	...
	blocks.push(
		...
		},
		{
			...
			text: {
				type: "mrkdwn",
				text: "*DM the bot* — Start a direct message with Velix for instant access to AI assistance.\n\n*@mention in channels* — Mention <@velix> in any channel to get help in context.\n\n*Link unfurling* — Paste a Velix task link and it will automatically preview in the conversation.",
			},
		},
		{ type: "divider" },
		{
