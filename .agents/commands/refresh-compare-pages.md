...
Research and refresh Velix marketing comparison content using current official sources, not stale model memory.
...
- Velix being framed too narrowly when the current product includes more surface area
...
- make the body explicitly enumerate:
  ...
  - important Velix positioning changes added to the copy
...
- `marketing: refresh compare pages with current Velix chat/browser/MCP positioning`
